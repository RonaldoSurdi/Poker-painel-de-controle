        ...
        <div class="row">
            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title text-semibold">Lista de ranking do seu clube
                        @if (isset($busca)) <span class="text-blue-800"> - pesquisando por {{$busca}}</span> @endif
                    </h6>
                    <div class="heading-elements">

                        <form class="heading-form mr-5" role="form" action="{{route('club.rank.search')}}" method="post">
                            {{ csrf_field() }}
                        ...
                        <a href="{{route('club.rank.new')}}" type="button" class="btn btn-primary heading-btn" id="btn_cad"><i class="icon-plus-circle2"></i> Adicionar</a>
                    </div>
                </div>
                ...
                <table class="table table-hover datatable-responsive">
                    ...
                    @forelse($lista as $cad)
                        <tr>
                            ...
                            {{--</td>--}}
                            <td>
                                <a href="{{route('club.rank.edit',['id'=>$cad->id])}}">{{$cad->title}}</a>
                            </td>
                            <td>
                                {!! $cad->torneio() !!}
                            </td>
                                ...
                                <ul class="icons-list">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{route('club.rank.edit',['id'=>$cad->id])}}"><i class="icon-pencil7"></i> Alterar</a></li>
                                            <li class="divider"></li>
                                            <li><a href="#" onclick="ask_url('Deseja excluir este ranking?','{{ route('club.rank.del',['id'=>$cad->id]) }}')">
